...
- [Basic Conversions](#basic-conversions)
  - [Markdown to Word (.docx)](#markdown-to-word-docx)
  - [Markdown to PDF](#markdown-to-pdf)
  - [Markdown to HTML (standalone with CSS)](#markdown-to-html-standalone-with-css)
  - [Markdown to PowerPoint (.pptx)](#markdown-to-powerpoint-pptx)
  - [Word to Markdown](#word-to-markdown)
  - [Word to PDF](#word-to-pdf)
  - [HTML to Word](#html-to-word)
  - [HTML to Markdown](#html-to-markdown)
  - [LaTeX to PDF](#latex-to-pdf)
  - [RST to HTML](#rst-to-html)
- [Table of Contents](#table-of-contents)
  - [PDF with TOC](#pdf-with-toc)
  - [HTML with TOC](#html-with-toc)
  - [Word with TOC](#word-with-toc)
  - [TOC with custom title](#toc-with-custom-title)
- [Custom Styling](#custom-styling)
  - [Word with custom reference template](#word-with-custom-reference-template)
  - [PowerPoint with custom reference template](#powerpoint-with-custom-reference-template)
  - [HTML with custom CSS](#html-with-custom-css)
  - [Syntax highlighting styles](#syntax-highlighting-styles)
- [Bibliography and Citations](#bibliography-and-citations)
  - [Basic citation processing](#basic-citation-processing)
  - [With CSL style](#with-csl-style)
  - [Example markdown with citations](#example-markdown-with-citations)
  - [Example .bib entry](#example-bib-entry)
- [Math Support](#math-support)
  - [HTML with MathJax](#html-with-mathjax)
  - [HTML with KaTeX (faster rendering)](#html-with-katex-faster-rendering)
  - [Markdown with math to PDF (LaTeX handles it natively)](#markdown-with-math-to-pdf-latex-handles-it-natively)
  - [Example markdown with math](#example-markdown-with-math)
- [Multi-File Input](#multi-file-input)
  - [Concatenate multiple markdown files into one document](#concatenate-multiple-markdown-files-into-one-document)
  - [Using a file list](#using-a-file-list)
- [Metadata](#metadata)
  - [YAML metadata block in markdown](#yaml-metadata-block-in-markdown)
  - [Metadata via command-line flags](#metadata-via-command-line-flags)
  - [Metadata file (separate YAML)](#metadata-file-separate-yaml)
- [Filters](#filters)
  - [Lua filter example — convert all text to uppercase in headings](#lua-filter-example--convert-all-text-to-uppercase-in-headings)
  - [pandoc-crossref for numbered figures, tables, equations](#pandoc-crossref-for-numbered-figures-tables-equations)
- [Slide Shows](#slide-shows)
  - [Markdown to reveal.js](#markdown-to-revealjs)
  - [Markdown to Beamer (LaTeX slides)](#markdown-to-beamer-latex-slides)
  - [Markdown to PowerPoint](#markdown-to-powerpoint)
  - [Example slide markdown](#example-slide-markdown)
- [EPUB Creation](#epub-creation)
  - [Basic EPUB](#basic-epub)
  - [Full-featured EPUB](#full-featured-epub)
  - [EPUB metadata XML](#epub-metadata-xml)
  - [Multi-chapter EPUB](#multi-chapter-epub)
- [Advanced Options](#advanced-options)
  - [Self-contained HTML (single file, all resources embedded)](#self-contained-html-single-file-all-resources-embedded)
  - [Extract media from a docx](#extract-media-from-a-docx)
  - [Numbered sections](#numbered-sections)
  - [Shift heading levels](#shift-heading-levels)
  - [Line wrapping control](#line-wrapping-control)
  - [Standalone vs fragment](#standalone-vs-fragment)
- [Python Integration](#python-integration)
  - [Basic conversion with subprocess](#basic-conversion-with-subprocess)
  - [Convert markdown string to HTML (stdin/stdout)](#convert-markdown-string-to-html-stdinstdout)
  - [Batch convert all markdown files in a directory](#batch-convert-all-markdown-files-in-a-directory)
  - [Chain pandoc with other tools](#chain-pandoc-with-other-tools)
- [PyMuPDF as PDF Alternative (No LaTeX Required)](#pymupdf-as-pdf-alternative-no-latex-required)
  - [pandoc Markdown to HTML, then fitz Story to PDF](#pandoc-markdown-to-html-then-fitz-story-to-pdf)
  - [With custom CSS passed in](#with-custom-css-passed-in)
