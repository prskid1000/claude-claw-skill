...
`claw pipeline` is a declarative multi-step recipe runner. It replaces the hand-written Python orchestration in [examples/data-pipelines.md](../../examples/data-pipelines.md) with a YAML DAG that any agent can emit, validate, diff, and re-run.
...
Replaces [examples/data-pipelines.md § Full Pipeline](../../examples/data-pipelines.md#full-pipeline-db-query-to-process-to-excel--pdf-to-upload-drive-to-email).
...
Replaces [examples/data-pipelines.md § CSV → Styled Excel → Google Sheets](../../examples/data-pipelines.md#csv-to-styled-excel-to-google-sheets).
...
Replaces [examples/data-pipelines.md § PDF → Extract Tables → Excel](../../examples/data-pipelines.md#pdf-to-extract-tables-to-excel) plus [XLSX → PDF](../../examples/data-pipelines.md#excel-to-pdf-reportlab-table).
